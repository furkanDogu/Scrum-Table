...
namespace Proje
{
    public partial class frmProjeler : Form
    {
        ...
        {   //Form ilk açılışta dgv'ye dt'den tabloları dolduruyor..
            ...
            SqlConnection baglan = new SqlConnection(@"Data Source = DESKTOP-U8UNER4\SQLEXPRESS; Initial Catalog = YazilimYapimi; Integrated Security = True");   
            baglan.Open();
        ...
        {           
            ...
            dgvprojeListesi.Rows[hm.Size - 1].Cells[0].Value = tableInfo[2]+ ") "+ tableInfo[0];
            SqlConnection con = new SqlConnection(@"Data Source = DESKTOP-U8UNER4\SQLEXPRESS; Initial Catalog = YazilimYapimi; Integrated Security = True");
            ...
            try
            {
                ...
                {   
                    case DialogResult.Yes://İlgili projeye ait verilerin silinmesi
                        SqlConnection baglan = new SqlConnection(@"Data Source = DESKTOP-U8UNER4\SQLEXPRESS; Initial Catalog = YazilimYapimi;MultipleActiveResultSets = True;  Integrated Security = True");
                        baglan.Open();
